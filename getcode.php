...
class GPT4Response
{
    ...
    public function __construct($api_key = null, $system_instruction = null, $assistant_instruction = null, $model = null)
    {
        ...
        $this->system_instruction = $system_instruction ?? "You are a specially designed GPT that writes amazing poems. Take the user input and write an amazing poem that evokes emotion. Include content from the input and write an amazing poem.";
        $this->assistant_instruction = $assistant_instruction ?? "Write a really awesome poem that invokes emotion about the following. Try to make it a really impressive poem that rhymes well. Write a poem based on the following user input: ";
